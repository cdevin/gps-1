...
from gps.proto.gps_pb2 import JOINT_ANGLES, JOINT_VELOCITIES, \
        ...
        TRIAL_ARM, AUXILIARY_ARM, JOINT_SPACE, IMAGE_FEAT#, RGB_IMAGE
from gps.utility.general_utils import get_ee_points
from gps.gui.config import generate_experiment_info
from gps.algorithm.policy_opt.tf_model_example import example_tf_network, multitask_multirobot_fc_supervised
...
EXP_DIR = BASE_DIR + '/../experiments/block_badmm/'
...
agent = {
    ...
    'T': 100,
    'x0': x0s,
    'ee_points_tgt': [np.zeros(9)]*len(ee_tgts),
...
algorithm['cost'] = [{
    'type': CostSum,
    'costs': [torque_cost, fk_cost1[i], fk_cost2[i]],
    'weights': [1.0, 1.0, 1.0],
} for i in range(common['conditions'])]
...
#     'type': PolicyOptCaffe,
#     'weights_file_prefix': EXP_DIR + 'policy',
#     'network_model': '/home/coline/caffe_models/forward_blocks.prototxt',
#     'iterations': 3000,
# }
